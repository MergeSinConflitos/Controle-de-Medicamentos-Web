...
4. Para executar o projeto compilando em tempo real
   ...
   ```bash
   dotnet run --project ControleDeMedicamentosWeb.WebApplication
   ```
(Caso a página não abra automaticamente após rodar,copie o localHost que aparece no terminal e cole no seu navegador) 

Exemplo: ```http://localhost:5164```   
